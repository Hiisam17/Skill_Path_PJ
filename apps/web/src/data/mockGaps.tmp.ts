...
export const MOCK_JOBS: SuggestedJob[] = [
  {
    ...
    description: `n      - Develop and maintain backend systems using ASP.NET / .NET (C#)
      - Collaborate with frontend teams using VueJS / ReactJS
      - Design and optimize SQL databases
      - Write clean, maintainable, and well-documented code
      - Participate in code reviews and technical discussions
    `,
    requirements: `n      - Proficient in C# and .NET / ASP.NET framework
    ...
    gapNodes: ["ASP.NET", "React", ".NET", "C#", "SQL"],
    source: "ITviec",
  ...
  },
  {
    ...
    jobType: "At office",
    highlights: [
      "Làm vi?c v?i các công ngh? m?i nh?t",
      "Linh v?c ch?ng khoán, tài chính h?p d?n",
      "Liên t?c du?c dào t?o chuyên môn, ki nang",
    ],
    description: `n      - Build and maintain backend systems for a securities/finance platform
    ...
    `,
    requirements: `n      - 2+ years of experience with Java and Spring Framework
    ...
    `,
    roadmapPath: "/roadmaps/javascript",
    gapNodes: ["Java", "Maven", "Spring Boot", "Relational Databases", "SQL"],
    source: "ITviec",
    sourceUrl: "https://itviec.com/it-jobs/back-end",
  },
  {
    ...
    description: `n      - Design and implement backend services using Golang
    ...
    `,
    requirements: `n      - Proficient in Golang (1+ year hands-on)
    ...
    `,
    roadmapPath: "/roadmaps/javascript",
    gapNodes: ["Go", "AWS", "Software Testing"],
    source: "ITviec",
    sourceUrl: "https://itviec.com/it-jobs/back-end",
  },
  {
    ...
    description: `n      - Develop and maintain web applications using Ruby on Rails
    ...
    `,
    requirements: `n      - 2+ years experience with Ruby on Rails
    ...
    `,
    roadmapPath: "/roadmaps/javascript",
    gapNodes: ["Ruby", "Ruby on Rails", "PostgreSQL", "Relational Databases", "REST"],
    source: "ITviec",
    sourceUrl: "https://itviec.com/it-jobs/back-end",
  },
  {
    ...
    description: `n      - Build scalable REST APIs using NodeJS and ExpressJS
    ...
    `,
    requirements: `n      - 2+ years of NodeJS / ExpressJS experience
    ...
    `,
    roadmapPath: "/roadmaps/javascript",
    gapNodes: ["Node.js", "Express", "PostgreSQL", "REST", "Git"],
    source: "ITviec",
    sourceUrl: "https://itviec.com/it-jobs/back-end",
  }
];
