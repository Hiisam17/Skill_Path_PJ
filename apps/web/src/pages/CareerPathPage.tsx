    ...
    <div className="min-h-screen bg-[#090E1A] text-white overflow-x-hidden">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-24 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col gap-7">
            ...
            <div className="flex">
              <span
                className="inline-flex items-center gap-2 text-xs text-[#00BDD6] font-medium
            ...
            <p className="text-[#94A3B8] text-lg leading-relaxed max-w-lg">
              Navigate the tech landscape with personalized, structured
              roadmaps. Go from zero to job-ready with skills that employers
              actually want.
            </p>
          ...
          <div className="relative hidden lg:flex items-center justify-center">
            ...
            <div
              ...
              style={{
                boxShadow:
                  "0 0 60px rgba(0,229,255,0.08), inset 0 0 60px rgba(0,189,214,0.04)",
              }}
            >
              {/* Grid lines */}
              <div
      ...
      >
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-[#94A3B8] max-w-xl mx-auto">
            Choose a path that aligns with your goals. Each roadmap is
            structured by industry experts and updated regularly.
          </p>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
        <div
          ...
          style={{
            background:
              "linear-gradient(135deg, #0d1829 0%, #111726 50%, #0a1535 100%)",
        ...
        >
          ...
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, rgba(0,189,214,0.15) 0%, transparent 70%)",
            }}
          />
          <div
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <p className="text-[#94A3B8] max-w-md text-lg">
              Join 200,000+ developers who are building their future with
              structured, expert-curated roadmaps.
            </p>
            <Button
